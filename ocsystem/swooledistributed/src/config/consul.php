...
//开放给本地
$config['consul']['client_addr'] = '0.0.0.0';
...
$config['consul']['start_join'] = ["119.23.229.66"];
//本地网卡设备
$config['consul']['bind_net_dev'] = "eth0";
//监控服务
$config['consul']['watches'] = ["ConsensusController"];
//发布服务
$config['consul']['services'] = ["ConsensusController:9091"];
